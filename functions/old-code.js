...
/*
<par>
  <media xml:id="supporters" fadeOutDur="5s" >
    <audio soundLevel="-15dB" clipBegin="2s" src='https://storage.googleapis.com/staging.worldcuppal.appspot.com/world_cup.mp3'></audio>
  </media>
  
  <media begin="2s">
	  <prosody volume="+20dB">what's up, my friend?</prosody>
    <break time="0.2s"/>
    <prosody volume="+6dB">Am you world cup buddy</prosody>
    <break time="1s"/>
    <prosody volume="+6dB">you can ask me about the world cup</prosody>
    <break time="1s"/>
    <prosody volume="+6dB">I can tell you about the different groups</prosody>
    <prosody volume="+6dB">different games and different teams</prosody>
    <break time="1s"/>
    <prosody volume="+6dB">I also know about stadiums, and where every game is played</prosody>
    <prosody volume="+6dB">So please don't be shy <break time="0.2s"/>just go ahead and ask!</prosody>
  </media>
</par>
